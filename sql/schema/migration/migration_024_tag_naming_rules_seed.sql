...
--
-- Actual table columns used:
--   domain, nr_code, canonical_name, regex_search, regex_full, sort_order, is_active
...
INSERT INTO audit_core.naming_rule (domain, nr_code, canonical_name, regex_search, regex_full, sort_order, is_active)
...
-- Verify:
-- SELECT nr_code, canonical_name, sort_order
