...
-- Generated: 2026-04-03  Fixed: 2026-04-03 (dollar-quote clash: $$^...$$ → $re$^...$re$)
...
--   regex_full values end with the regex anchor '$'.
--   Using plain $$ as delimiter produces the sequence $$$  which PostgreSQL
--   mis-parses (closes $$ then sees a stray $).
--   Solution: use named tag  $re$ ... $re$  for every regex_full value.
--   regex_search values do NOT end with '$', so plain $$ is safe there.
