...
def _build_prompt(
    ...
    system_msg = (
        ...
        "Set confidence >= 0.85 ONLY when the comment clearly and unambiguously "
        "matches a category description. "
        ...
        "Set confidence <= 0.30 and use category 'OTHER' when the comment does not "
        "match any available category, is a recommendation rather than a data error, "
        "is informational, or you are guessing. "
